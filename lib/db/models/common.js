...
module.exports = class CommonModel {
  ...
  #QUERIES = {
    ...
    select: (knex, query) => {
      ...
      throw Error(`[CommonModel]: Invalid select input: ${query}`);
    },
    ...
    orderBy: (knex, query) => {
      ...
      throw Error(`[CommonModel]: Invalid orderBy input: ${query}`);
    },
    ...
    join: (knex, query) => {
      ...
      throw new Error(`[CommonModel]: Invalid join input: ${query}`);
    }
  };
